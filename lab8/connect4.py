...
class Joc:
    ...
    def get_diagonala(self, linie, coloana):
        lista_return = []
    ...
    def final(self):
        ...
        for i in range(self.NR_LINII):
            for j in range(self.NR_COLOANE):
                diagonala1 = self.get_diagonala(i, j)
                diagonala2 = self.get_diagonala2(i, j)
                if len(set(diagonala1)) == 1 and '#' not in diagonala1:
                    return diagonala1[0]
                if len(set(diagonala2)) == 1 and '#' not in diagonala2:
                    return diagonala2[0]
    ...
    def nr_intervale_deschise(self, jucator):
        ...
        for i in range(self.NR_LINII):
            for j in range(self.NR_COLOANE):
                diagonala1 = self.get_diagonala(i, j)
                diagonala2 = self.get_diagonala2(i, j)
                if juc_opus not in diagonala1:
                    rez += 1
                if juc_opus not in diagonala2:
                    rez += 1
